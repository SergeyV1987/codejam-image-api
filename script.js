...
let imageLoad = document.getElementsByClassName("load")[0];
...
function activateImageLoad() {
    let canvasWidth = document.getElementById("canvas").width;
    let canvasHeight = document.getElementById("canvas").height;

    const url = 'https://api.unsplash.com/photos/random?query=town,Minsk&client_id=949d309a09bedbc642b2a762c9aa8c50bd9e64125b0d961bfc2ab6c3b5f81318';
...
imageLoad.onclick = activateImageLoad;
